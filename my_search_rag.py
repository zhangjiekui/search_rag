...
os.environ["SEARCHAPI_API_KEY"] = "AhsJfc1eGys7vjQ3jmYu2kQg"
os.environ["BACKEND"] = "SEARCHAPI"
os.environ["OPENAI_API_KEY"]='not used'
# os.environ["OPENAI_BASE_URL"]='http://127.0.0.1:8000/v1'
# os.environ["LLM_MODEL"] = "gpt-3.5-turbo"
os.environ["OPENAI_BASE_URL"]='http://10.1.150.105:9997/v1'
os.environ["LLM_MODEL"] = "qwen1.5-chat"
os.environ["RELATED_QUESTIONS"]='1'
...
client = openai.OpenAI(
    base_url="http://10.1.150.105:9997/v1",
    api_key="not used",
)
messages = [
...
async def server_init(_app, loop):
    ...
    _app.ctx.http_session = httpx.AsyncClient(
        timeout=httpx.Timeout(connect=100, read=1200, write=1200, pool=100),
    )
...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=port, workers=workers, debug=True)
